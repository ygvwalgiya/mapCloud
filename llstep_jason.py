...
class LLStepData(object):
    def __init__(self, config):
        ...
        self._shapeModelFilenameRight = os.path.join(DATA_DIRECTORY, 'data/shape_models/LLP26_right_mirrored_from_left_rigid.pc')
        self._boneModelFilenamesRight = {'pelvis': (os.path.join(DATA_DIRECTORY, 'data/atlas_meshes/pelvis_combined_cubic_mean_rigid_LLP26.geof'),
                                        os.path.join(DATA_DIRECTORY, 'data/atlas_meshes/pelvis_combined_cubic_flat.ens'),
                                        os.path.join(DATA_DIRECTORY, 'data/atlas_meshes/pelvis_combined_cubic_flat.mesh'),
                                        ),
                            'femur': (os.path.join(DATA_DIRECTORY, 'data/atlas_meshes/femur_right_mirrored_from_left_mean_rigid_LLP26.geof'),
                                        os.path.join(DATA_DIRECTORY, 'data/atlas_meshes/femur_right_quartic_flat.ens'),
                                        os.path.join(DATA_DIRECTORY, 'data/atlas_meshes/femur_right_quartic_flat.mesh'),
                                        ),
                            'patella': (os.path.join(DATA_DIRECTORY, 'data/atlas_meshes/patella_right_mirrored_from_left_mean_rigid_LLP26.geof'),
                                        os.path.join(DATA_DIRECTORY, 'data/atlas_meshes/patella_11_right.ens'),
                                        os.path.join(DATA_DIRECTORY, 'data/atlas_meshes/patella_11_right.mesh'),
                                        ),
                            'tibiafibula': (os.path.join(DATA_DIRECTORY, 'data/atlas_meshes/tibia_fibula_cubic_right_mirrored_from_left_mean_rigid_LLP26.geof'),
                                            os.path.join(DATA_DIRECTORY, 'data/atlas_meshes/tibia_fibula_right_cubic_flat.ens'),
                                            os.path.join(DATA_DIRECTORY, 'data/atlas_meshes/tibia_fibula_right_cubic_flat.mesh'),
                                            ),
                                }
        self._shapeModelFilenameLeft = os.path.join(DATA_DIRECTORY, 'data/shape_models/LLP26_rigid.pc')
        self._boneModelFilenamesLeft = {'pelvis': (os.path.join(DATA_DIRECTORY, 'data/atlas_meshes/pelvis_combined_cubic_mean_rigid_LLP26.geof'),
                                        os.path.join(DATA_DIRECTORY, 'data/atlas_meshes/pelvis_combined_cubic_flat.ens'),
                                        os.path.join(DATA_DIRECTORY, 'data/atlas_meshes/pelvis_combined_cubic_flat.mesh'),
                                        ),
                            'femur': (os.path.join(DATA_DIRECTORY, 'data/atlas_meshes/femur_left_mean_rigid_LLP26.geof'),
                                        os.path.join(DATA_DIRECTORY, 'data/atlas_meshes/femur_left_quartic_flat.ens'),
                                        os.path.join(DATA_DIRECTORY, 'data/atlas_meshes/femur_left_quartic_flat.mesh'),
                                        ),
                            'patella': (os.path.join(DATA_DIRECTORY, 'data/atlas_meshes/patella_left_mean_rigid_LLP26.geof'),
                                        os.path.join(DATA_DIRECTORY, 'data/atlas_meshes/patella_11_left.ens'),
                                        os.path.join(DATA_DIRECTORY, 'data/atlas_meshes/patella_11_left.mesh'),
                                        ),
                            'tibiafibula': (os.path.join(DATA_DIRECTORY, 'data/atlas_meshes/tibia_fibula_cubic_left_mean_rigid_LLP26.geof'),
                                            os.path.join(DATA_DIRECTORY, 'data/atlas_meshes/tibia_fibula_left_cubic_flat.ens'),
                                            os.path.join(DATA_DIRECTORY, 'data/atlas_meshes/tibia_fibula_left_cubic_flat.mesh'),
                                            ),
                                }
        self._validRegistrationModes = ('shapemodel',)
